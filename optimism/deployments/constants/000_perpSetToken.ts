...
// These values are the name and symbol fields of the deployed ERC-20. Customize as necessary.
export const PERP_SET_TOKEN_NAME = "PERP_SET_TOKEN";
export const PERP_SET_TOKEN_SYMBOL = "PST";
